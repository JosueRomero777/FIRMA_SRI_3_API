...
// Nombre del XML a firmar
$nombrexml = "/home/axcalle/Downloads/FIRMA_SRI_3/PorFirmar/invoice_84e166b9-6ffe-427d-8326-74af608241eb.xml";

// Ruta donde se guardarán los XML firmados
$rutafirmados = '/home/axcalle/Downloads/FIRMA_SRI_3/firmados/';

// Ruta del certificado
$pathCertificate = './GERENTE GENERAL JOHANA MARGEORY MONTENEGRO CORDOVA 1104054679-140324164407.p12';

// Clave del certificado
$p12Password = 'cejx2324';

// Cargar el contenido del XML no firmado
$contenido = file_get_contents($nombrexml);

// Crear la instancia del firmador
$factura_firmada = new SignDOcumentToSRI('factura', $pathCertificate, $p12Password, $contenido);

// Extraer solo el nombre del archivo del XML original
$nombreArchivo = basename($nombrexml); // Resultado: "factura_53467.xml"

// Construir la ruta completa donde se guardará el archivo firmado
$rutaArchivoFirmado = $rutafirmados . $nombreArchivo;

// Guardar el archivo firmado en la nueva ruta
if (file_put_contents($rutaArchivoFirmado, $factura_firmada->xml)) {
    // Operación exitosa
    echo json_encode(array('error' => false));
    echo "<br><br><a href='autorizar.php'>Autorizar Documento</a>";
} else {
    // Operación fallida
